...
//filter cria uma nova array filtrando os itens que passou no teste 
...
//reduce resume a array / toLocaleString formata o valor em R$
...
let valorTotal = produtos.reduce((acumulador, produto) => acumulador + (produto.preco_venda*produto.estoque),0);
...
//filter retorna uma nova array com os itens que passaram no teste, nesse caso os produtos com estoque menor ou igual a 50
let estoque = produtos.filter ((produto) => produto.estoque <= 50 );
console.table(estoque);

//find retorna o primeiro item que encontrar, diferente do filter que retorna uma nova array com os itens que passaram no teste
